...
class Room1{
    ...
    function getairValue2Room1(){
      ...
      //function getAllTempLessThan20Room1 ที่ทำงานกับ getAllTempLessThan20Room1.php
    //วัตถุประสงค์ของฟังก์ชันนี้คือ ต้องการอุณหภูของแอร์ทุกตัวตัวที่น้อยกว่า 20 องศา ของห้อง Room1
